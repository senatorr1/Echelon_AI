...
class BusinessAdvisor:
    ...
    # --- Structural Fix: Passing conversation_history to the main function ---
    def process_income_query(self, user_input, conversation_history=None): 
        ...
        # Stage 3: Information gathering
            ...
            # Pass history for the next step, recommendations
    ...
    # --- FLEXIBILITY FIX 1: Enhanced _handle_initial_query for robust intent detection and direct routing ---
    def _handle_initial_query(self, user_input):
        """Handle first interaction with enhanced flexibility and robust intent detection"""
        user_lower = user_input.lower()
        
        # Expanded keywords for maximum flexibility, covering general needs and specific tasks
...
**I see you haven't asked an income-related question yet!**
Tell me, using your own words, how I can help you start earning. For example:
- "I need some spare funds to cover up some bills"
...
KEY INSTRUCTION: Be extremely flexible in understanding the user's input. Do not revert to generic questions if a clear intent (like asking for funds or bills help) is present. Focus on opportunities suitable for Nigerian students. You have access to the full conversation history to maintain context.
"""
